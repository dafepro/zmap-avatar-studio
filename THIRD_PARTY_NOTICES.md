...
The active local locomotion curves, wave/cheer emotes, and equipment pickup adaptations derive from **KayKit Character Animations 1.1** by Kay Lousberg, licensed under [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/).
