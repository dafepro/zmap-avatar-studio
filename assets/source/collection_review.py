...
"""
COLLECTION_COLORS={
 'ember':{'primary':'#cf641e','skin':'#9e6542','hair':'#30251f','secondary':'#292b2d','trim':'#f5f2eb'},
...
for index,(style,colors) in enumerate(COLLECTION_COLORS.items()):
    ...
    for view,eye,target,scale in [('front',(x,1.13,4),(x,1.13,-3),2.35),('side',(x+7,1.13,-3),(x,1.13,-3),2.35),('top',(x,7,-3),(x,1.10,-3),1.12)]:
...
def render_collection_views():
    ...
    review_roots=[study_front,study_side,look_front,look_three,look_side]+list(collection_previews.values())
